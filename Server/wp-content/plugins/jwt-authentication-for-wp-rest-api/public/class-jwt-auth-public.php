...
class Jwt_Auth_Public
{
    ...
    public function generate_token($request)
    {
        ...
        $registration_token = $request->get_param('registration_token');
     ...
     */
    public function validate_ptoken($token ="")
    {
        // if($token ="")
        // {
        //     return "Error";
    ...
    public function validate_token($output = true)
    {
        ...
        if (!$auth) { $allHeaders = getallheaders(); $auth = $allHeaders['Authorization']; } 
