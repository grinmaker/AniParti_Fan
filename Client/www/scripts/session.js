...
/*  var showDialog = function () {
  ...
  if ($("div#menu-1").length) {
    ...
    //   });
          ...
          console.log("setting");
          $("li#li_nick_name").html(pScreenObj.mpNickName + ' <strong id="user_nicename">(' + session.user_nicename + ')</strong><a href="#" data-menu="edit-nickname-modal" class="color-red">' + pScreenObj.mpEdit + '</a>');
          $("li#li_user_id").html(pScreenObj.mpUserId + ' <strong id="user_email">(' + session.user_email + ')</strong>');
          if (session.gender) {
              var gender = $("input[name='rad1']:checked").val();
              ...
              $("li#li_gender").html(pScreenObj.mpGender + ' <strong id="user_gender">(' + session.gender + ')</strong> <a href="#" data-menu="edit-gender-modal">' + pScreenObj.mpEdit + '</a>');
          } else {
              $("input[name='rad1']").each(function () {
              ...
              $("li#li_gender").html(pScreenObj.mpGender + ' <strong id="user_gender">(' + pScreenObj.mpMale + ')</strong> <a href="#" data-menu="edit-gender-modal">' + pScreenObj.mpEdit + '</a>');
          }
          if (session.dob ) {
              $("li#li_dob").html(pScreenObj.mpBirthday + ' <strong id="user_dob">(' + session.dob + ')</strong>  <a href="#" data-menu="edit-bday-modal">' + pScreenObj.mpEdit + '</a>');
          } else {
              $("li#li_dob").html(pScreenObj.mpBirthday + ' <strong id="user_dob">()</strong>  <a href="#" data-menu="edit-bday-modal">' + pScreenObj.mpEdit + '</a>');
          }
      }
